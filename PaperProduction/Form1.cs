...
namespace PaperProduction
{
    public partial class AddToDatabaseForm : Form
    {
        ...
        private void initForm()
        {
            ...
            paperNameComboBox.Items.AddRange(new string[] { "Бумага А3 80 г/м2 500 л \"SvetoCopi\"",
            ...
            bindingMaterialsComboBox.Items.AddRange(new string[] { "Картон коробочный м. КТ, фор. 74*105 см, толщ. 09 мм",
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            double masterFilmText = double.TryParse(masterFilmTextTextBox.Text, out val) ? double.Parse(masterFilmTextTextBox.Text) : 0;
            ...
            command.Parameters.Add("@master_film_text", MySqlDbType.VarChar).Value = masterFilmTextTextBox.Text;
            ...
            command.Parameters.Add("@paper_name", MySqlDbType.VarChar).Value = paperNameComboBox.Text;
            command.Parameters.Add("@total_weight", MySqlDbType.Double).Value = Math.Round(paper1 * m, 4);
            command.Parameters.Add("@name_of_binding_materials", MySqlDbType.VarChar).Value = bindingMaterialsComboBox.Text;
